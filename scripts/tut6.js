...
btn2.on("click", () => {
    ...
    vib.prop("disabled", false);
    squ.prop("disabled", false);
    str.prop("disabled", false);
    rin.prop("disabled", false);
    sha.prop("disabled", false);
...
function handleMessage(mEvent) {
    ...
    switch (msg.type) {
        ...
        case MessageType.SOMETHING:
            if(msg.message == "squeek"){
                new Audio('../resources/P2/squeek.mp3').play();
            }
            else if(msg.message == "vibrate"){
                window.navigator.vibrate(1000);
            }
            else if(msg.message == "strum"){
                new Audio('../resources/P2/strum.mp3').play();
            }
            else if(msg.message == "ring"){
                new Audio('../resources/P2/ring.mp3').play();
            }
            else if(msg.message == "shake"){
                new Audio('../resources/P2/shake.mp3').play();
            }
